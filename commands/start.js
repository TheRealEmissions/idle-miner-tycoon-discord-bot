   ...
   async run(client, message, args) {
      const msg = await message.channel.send(
         new client.modules.Discord.MessageEmbed()
            ...
            .setDescription(
               `Constructing your profile... <:evilpatrick:630505477062787092>`
            )
      );
      client.models.userProfiles.findOne(
         ...
         async (err, db) => {
            ...
            if (!db) {
               await new setupDatabase(client, message)
                  .init()
               ...
               msg.edit(
                  new client.modules.Discord.MessageEmbed()
                     .setColor(message.guild.me.displayHexColor)
                     .setDescription(
                        `Created your profile... :ballot_box_with_check:`
                     )
               );
               ...
               msg.edit(
                  new client.modules.Discord.MessageEmbed()
                     .setColor(message.guild.me.displayHexColor)
                     .setDescription(
                        `Unfortunately, a profile already exists for your user! You can reset your profile by running \`.restart\``
                     )
               );
            }
         }
